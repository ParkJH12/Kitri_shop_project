...
<c:set var="str">readonly</c:set> <!-- str이라는 변수를 만들어서 readonly 값을 넣어줌  -->

</c:if>
<form name="f">
num:<input type="text" name="num" value="${a.num}" readonly><br>
writer:<input type="text" name="writer" value="${a.writer}" readonly><br>
date:${a.w_date }<br>
title:<input type="text" name="title" value="${a.title}" ${str }><br>
content:<input type="text" name="content" value="${a.content}" ${str }><br>
...
<tr><td>${rep.writer}</td>
<td><a href="${pageContext.request.contextPath}/board/read.do?num=${rep.num}"}>${rep.content }</a></td></tr>
